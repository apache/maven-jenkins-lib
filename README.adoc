= Apache Maven Jenkins Shared Librariy

This repository contains the Jenkins shared library that define the standard build process for Apache Maven subprojects.
